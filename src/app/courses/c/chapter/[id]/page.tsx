        ...
        if (resumeRes.ok) {
          ...
          if (resumeData.success) {
            ...
            if (resumeData.shouldChapterRecap) {
              const chapterRecapKey = `ksai_chapter_recap_${userEmail}_c_${currentChapter.id}`;
              ...
              const recapKey = `ksai_quick_recap_${userEmail}_c_${currentChapter.id}_${recapTopic}`;
