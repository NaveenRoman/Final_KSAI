      ...
      if (resumeRes.ok) {
        ...
        if (resumeData.success) {
          ...
          if (resumeData.shouldChapterRecap) {
            const chapterRecapKey = `ksai_chapter_recap_${userEmail}_java_${currentChapter.id}`;
            ...
            const recapKey = `ksai_quick_recap_${userEmail}_java_${currentChapter.id}_${recapTopic}`;
      ...
      <div className="flex-1 flex w-full overflow-hidden">
        ...
        <main data-lenis-prevent className="flex-1 p-4 sm:p-6 lg:p-8 space-y-6 overflow-y-auto w-full bg-slate-50 custom-scrollbar">
          ...
          {loading ? (
            ...
            <LockedChapterCard
              courseSlug="java"
              courseTitle="Java Enterprise Architecture Mastery"
